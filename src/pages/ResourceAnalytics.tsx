  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto px-4 py-8 md:p-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
        <div>
          <label className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.2em] text-orange-500">
            Analytics
          </label>
          <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tight mt-1 text-zinc-900 dark:text-white">
            Business Intelligence
          </h1>
          <p className="text-zinc-600 dark:text-zinc-400 mt-2 font-medium text-sm">
              ...
              <button
                ...
                className={cn(
                  ...
                  timeframe === tf
                    ...
                    : "text-zinc-500 hover:text-zinc-900 dark:text-white",
                )}
              >
                {tf}
              </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        <Card className="border border-blue-500/30 rounded-2xl shadow-lg relative overflow-hidden group">
          ...
          <CardContent className="p-5 sm:p-6 relative z-10">
            ...
            <p className="text-xs text-zinc-500 mt-4 tracking-wider uppercase font-bold">
                      ...
                      if (active && payload && payload.length) {
                        return (
                          <div className="bg-white dark:bg-black/90 backdrop-blur-sm border border-black/10 dark:border-white/20 p-3 shadow-2xl">
                            <p className="text-zinc-600 dark:text-zinc-400 text-[10px] font-bold uppercase tracking-widest mb-2">
                              {label}
                            </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-6">
          ...
          <CardContent className="p-5 md:p-6">
            <div className="flex justify-between items-center mb-6 border-b border-black/5 dark:border-white/5 pb-4">
              <div>
                <h2 className="text-lg font-black uppercase text-zinc-900 dark:text-white flex items-center gap-2">
                  <Zap className="w-5 h-5 text-amber-500" /> Utility Logging
                </h2>
                <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest mt-1">
                  Track power, gas, and RO usage
                </p>
              </div>
              <button
                onClick={() => setIsUtilityModalOpen(true)}
                className="bg-black dark:bg-white text-white dark:text-black px-4 py-2 text-xs font-black uppercase tracking-widest rounded-xl hover:opacity-80 transition-opacity"
              >
                Log Metrics
              </button>
            </div>
            <div className="space-y-4 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
              {utilityMetrics.length === 0 ? (
                <div className="text-center text-sm font-bold uppercase tracking-widest text-zinc-500 py-10">
                ...
                utilityMetrics
                  ...
                  .map((m) => (
                    <div
                      key={m.id}
                      className="bg-black/5 dark:bg-white/5 p-4 rounded-xl flex flex-wrap items-center justify-between gap-4"
                    >
                      <div className="font-black text-zinc-900 dark:text-white uppercase tracking-widest text-sm">
                        {m.date}
                      </div>
        ...
        <Card className="rounded-2xl shadow-xl border-black/[0.04] dark:border-white/[0.06] overflow-hidden">
          <CardContent className="p-5 md:p-6 h-full flex flex-col">
            <h2 className="text-lg font-black uppercase tracking-tight text-zinc-900 dark:text-white mb-6">
              Consumption Trends
            </h2>
            <div className="h-[300px] w-full">
              {utilityMetrics.length === 0 ? (
                <div className="h-full flex items-center justify-center text-center text-sm font-bold uppercase tracking-widest text-zinc-500 border border-dashed border-black/10 dark:border-white/10 rounded-xl">
      ...
      >
        <form
          ...
          className="p-4 sm:p-6 space-y-4 bg-[#f4f4f5] dark:bg-[#111] rounded-2xl mx-1 mb-2 mt-4 mt-4"
        >
            <div>
              ...
              <input
                ...
                className="w-full bg-white dark:bg-black border border-black/10 dark:border-white/10 rounded-xl px-4 py-3 text-sm font-bold text-zinc-900 dark:text-white focus:outline-none focus:border-orange-500"
              />
            </div>
            <div>
              <label className="text-[10px] font-bold uppercase tracking-widest text-zinc-500 mb-1 block">
            ...
            <div className="flex gap-3 pt-4 border-t border-black/5 dark:border-white/5 mt-6">
              <button
                ...
                className="flex-1 py-3 text-sm font-black uppercase tracking-widest text-zinc-500 bg-white dark:bg-black border border-black/10 dark:border-white/10 rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors"
              >
                Cancel
              </button>
              <button
                type="submit"
                className="flex-1 py-3 text-sm font-black uppercase tracking-widest text-white bg-emerald-500 hover:bg-emerald-600 shadow-lg shadow-emerald-500/20 rounded-xl transition-all active:scale-95"
              >
                Save Log
              </button>
            </div>
