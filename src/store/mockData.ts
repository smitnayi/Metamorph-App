...
export const mockUsers: User[] = [
  { id: 'u1', name: 'John Doe', email: 'john@powderos.com', role: 'Admin', department: 'Management', status: 'Active' },
  { id: 'u2', name: 'Sarah Smith', email: 'sarah@powderos.com', role: 'Manager', department: 'Production', status: 'Active' },
  { id: 'u3', name: 'Mike Johnson', email: 'mike@powderos.com', role: 'Worker', department: 'Coating', status: 'Active' },
];
